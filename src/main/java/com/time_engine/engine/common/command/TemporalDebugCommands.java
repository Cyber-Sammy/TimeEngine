...
public final class TemporalDebugCommands {
                                                ...
                                                context ->
                                                        showRelation(
                                                                ...
                                                                EntityArgument.getEntity(
                                                                        context, "target")))));
        root.then(CausalDebugCommands.create());
        root.then(TemporalPolicyDebugCommands.create());
    ...
    static void sendSuccess(CommandSourceStack source, String format, Object... arguments) {
